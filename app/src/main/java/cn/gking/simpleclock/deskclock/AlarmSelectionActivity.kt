...
import cn.gking.simpleclock.deskclock.widget.selector.AlarmSelection
import cn.gking.simpleclock.deskclock.widget.selector.AlarmSelectionAdapter
...
class AlarmSelectionActivity : ListActivity() {
    ...
    companion object {
        ...
        const val EXTRA_ACTION = "cn.gking.simpleclock.deskclock.EXTRA_ACTION"
        const val EXTRA_ALARMS = "cn.gking.simpleclock.deskclock.EXTRA_ALARMS"
    }
}