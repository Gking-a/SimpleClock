...
class AlarmService : Service() {
    ...
    companion object {
         ...
         * ALARM_DONE_ACTION).
         */
        const val ALARM_SNOOZE_ACTION = "cn.gking.simpleclock.deskclock.ALARM_SNOOZE"
         ...
         */
        const val ALARM_DISMISS_ACTION = "cn.gking.simpleclock.deskclock.ALARM_DISMISS"

        /** A public action sent by AlarmService when the alarm has started.  */
        const val ALARM_ALERT_ACTION = "cn.gking.simpleclock.deskclock.ALARM_ALERT"

        /** A public action sent by AlarmService when the alarm has stopped for any reason.  */
        const val ALARM_DONE_ACTION = "cn.gking.simpleclock.deskclock.ALARM_DONE"
