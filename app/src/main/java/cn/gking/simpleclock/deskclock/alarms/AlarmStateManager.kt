...
package cn.gking.simpleclock.deskclock.alarms
...
import cn.gking.simpleclock.deskclock.AlarmAlertWakeLock
import cn.gking.simpleclock.deskclock.AlarmClockFragment
import cn.gking.simpleclock.deskclock.AlarmUtils
import cn.gking.simpleclock.deskclock.AsyncHandler
import cn.gking.simpleclock.deskclock.DeskClock
...
import cn.gking.simpleclock.deskclock.provider.ClockContract.InstancesColumns
...
class AlarmStateManager : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_ALARM_CHANGED = "cn.gking.simpleclock.deskclock.ALARM_CHANGED"
