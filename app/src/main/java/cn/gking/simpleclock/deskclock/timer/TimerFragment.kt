...
package cn.gking.simpleclock.deskclock.timer
...
import cn.gking.simpleclock.deskclock.data.TimerListener
import cn.gking.simpleclock.deskclock.data.TimerStringFormatter
...
class TimerFragment : DeskClockFragment(UiDataModel.Tab.TIMERS) {
    ...
    companion object {
        private const val EXTRA_TIMER_SETUP = "cn.gking.simpleclock.deskclock.action.TIMER_SETUP"
