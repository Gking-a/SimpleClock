 ...
 * the License.
 */
package cn.gking.simpleclock.alarmclock
...
import cn.gking.simpleclock.deskclock.worldclock.CitySelectionActivity
...
class DigitalAppWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
         ...
         */
        private const val ACTION_ON_DAY_CHANGE = "cn.gking.simpleclock.deskclock.ON_DAY_CHANGE"
